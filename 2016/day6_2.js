var lineReader = require('readline').createInterface({
    input: require('fs').createReadStream(__dirname + '/day6.input')
});

const positionsArray = [new Map(), new Map(), new Map(), new Map(), new Map(), new Map(), new Map(), new Map()];
...
lineReader.on('close', function() {
    const positionMins = [Infinity, Infinity, Infinity, Infinity, Infinity, Infinity, Infinity, Infinity];
    const password = [];
